...
def run(*args):
    ...
    # websockets api
    ws_factory = WSFactory("ws://localhost:18466", mserver, kserver)
...
''')
        ...
        python openbazaard.py start [-d DAEMON]''')
            ...
            parser.add_argument('-r', '--restallowip', default="localhost",
                                help="bind the rest api server to this ip")
            parser.add_argument('-w', '--wsallowip', default="localhost",
